...
**Role:** Extracts riskiest assumptions and defines MVP to test them

**Tools:** None (analysis only)

**Output:** Prioritized assumptions, MVP definition, success metrics
...
└──────────────┬──────────────┘
               ...
               ▼
┌──────────────────────────────┐
│  Hypothesis Architect Agent  │  ◄── This repo
│       (GitHub Actions)       │
└───────────────┬──────────────┘
               │
               ▼
...
curl -X POST \
  ...
  https://api.github.com/repos/Othentic-Ai/ideation-agent-hypothesis-architect/dispatches \
