...
This is a specialized Claude Code agent for Lean Startup framework.
...
Read the system prompt at `src/ideation_agent_hypothesis_architect/prompts/system.md` for the agent's detailed behavior.
